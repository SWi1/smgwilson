...
<figure class="gallery__item">
  <img src="{{ site.baseurl }}/assets/images/taxaHFE_logo.png" alt="black logo with dendrogram and trees for taxaHFE software program">
  <figcaption>TaxaHFE: A taxonomically aware program that facilitates hierarchical feature engineering.</figcaption>
</figure>

<figure class="gallery__item">
  <img src="{{ site.baseurl }}/assets/images/FoodMapper_logo.png" alt="green and blue logo with food icons and Food Mapper in white text">
  <figcaption>FoodMapper: A program that uses neural embeddings to match food descriptions between two databases.</figcaption>
</figure>

<figure class="gallery__item">
  <img src="{{ site.baseurl }}/assets/images/dietML_logo.png" alt="brown logo with pizza slice on the left, a bar plot on the right, and dietML as black text">
  <figcaption>dietML: A program for applying machine learning in nutrition science.</figcaption>
</figure>

<figure class="gallery__item">
  <img src="{{ site.baseurl }}/assets/images/LGBTQIA_Mentor.png" alt="checkmark with LGBTIA colors and mentor in black text">
